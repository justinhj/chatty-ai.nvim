...
function M.complete(source_config, completion_config, target_config, should_stream)
  return C.completion_job(source_config, completion_config, target_config, should_stream)
end
